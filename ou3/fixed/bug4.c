...
/* 
 * Fixes:
 * Removed duplicate caesar() call, replaced exit() with "running = false", 
 * added freeing of outString at the end of every iteration of the while-loop, 
 * placed the printing of outString in an else-statement.
 */
int main(void) {
	char *str=malloc(255);
	char *outString=NULL;
